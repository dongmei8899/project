    ...
    function goods(){
        ...
        $.ajax({
          ...
          success: function(arr){
            ...
            for(var i = 0; i < arr.length; i++){
              str += `<article>
                <a href="detail.html"><img src="${arr[i].img}" alt=""></a>
                <p>
                    <span class="name">${arr[i].name}</span>
                    <em class="price">${arr[i].price}</em>&nbsp;
                    <i class="discount">${arr[i].discount}</i></p>
                <p class="type">${arr[i].type}</p>
                <button class="add" id="${arr[i].id}">加入购物车</button>
            </article>
                `
            }
            $("#product").html(str);
        ...
        function sc_msg(){
          ...
          <div class="sc_goodsTitle">
              <p>这是${newArr[i].type}</p>
          </div>
          <div class="sc_goodsBtn"><a href="detail.html">购买</a></div>
